class Shader {
    ...
    static renderRayData(rayData, renderDistance) {
        ...
        if(
            rayData.target.x === Math.floor(rayData.origin.x) ||
            rayData.target.y === Math.floor(rayData.origin.y) ||
            rayData.target.z === Math.floor(rayData.origin.z)
        ) {
            return Shader.distancePass(
                ...
                Math.floor(255 / rayData.direction.x),
                Math.floor(255 / rayData.direction.y),
                Math.floor(255 / rayData.direction.z),
            ), 0.2);
        }
