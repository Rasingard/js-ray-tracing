class Map {
    constructor(sX, sY, sZ) {
        ...
        this.addMaterial = (color, textureSRef, textureTRef, textureDRef, opacity, specular, roughness) => materials.add(color, textureSRef, textureTRef, textureDRef, opacity, specular, roughness);
        ...
        // Lights
        const globalLight = new GlobalLight(new Color(255, 250, 175), 0.85, (new Vector(-87, -47, -17)).normalize());
        this.getGlobalLight = () => globalLight;

        const ambientLight = new AmbientLight(new Color(132, 235, 255), 0.65);
