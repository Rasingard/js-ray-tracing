class Map {
    constructor(sX, sY, sZ) {
        ...
        this.addMaterial = (color, textureTRef, textureSRef, textureDRef) => materials.add(color, textureTRef, textureSRef, textureDRef);
        ...
        // Lights
        const globalLight = new GlobalLight(new Color(255, 250, 175), 0.75, (new Vector(-2, -1, -2)).normalize() );
