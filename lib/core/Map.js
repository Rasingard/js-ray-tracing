class Map {
    constructor(sX, sY, sZ) {
        ...
        // Lights
        const globalLight = new GlobalLight(SUN_COLOR, SUN_INTENSITY, (new Vector(0, -1, 0)).normalize());
        this.getGlobalLight = () => globalLight;

        const ambientLight = new AmbientLight(AMBIENT_LIGHT, AMBIENT_INTENSITY);
