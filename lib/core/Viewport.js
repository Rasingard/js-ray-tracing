class Viewport {
    constructor() {
        this.width = 200; // (window.innerWidth % 10 === 0) ? window.innerWidth : (Math.floor(window.innerWidth / 10) * 10);
        this.height = 120; // (window.innerHeight % 10 === 0) ? window.innerHeight : (Math.floor(window.innerHeight / 10) * 10);
