class Color {
    ...
    darkenC(t, b) { return Math.min(t, b); }
    darken(color) {
        this.r = this.darkenC(color.r, this.r);
        this.g = this.darkenC(color.g, this.g);
        this.b = this.darkenC(color.b, this.b);
        return this;
    }

    lightenC(t, b) { return Math.max(t, b); }
    lighten(color) {
        this.r = this.lightenC(color.r, this.r);
        this.g = this.lightenC(color.g, this.g);
        this.b = this.lightenC(color.b, this.b);
        return this;
    }
